...
CodeWars Kata Link: https://www.codewars.com/kata/526989a41034285187000de4/train/javascript
...
function ipsBetween(start, end) {
    ...
    return Math.abs(ip2int(start) - ip2int(end));
}

// Code for local testing beyond this line
